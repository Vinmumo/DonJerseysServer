...
def seed_data():
    ...
    products = [
        ...
        Product(name="Soccer Ball", description="FIFA approved soccer ball.", price=24.99, category_id=2, image_url="https://ke.jumia.is/unsafe/fit-in/500x500/filters:fill(white)/product/84/9075231/1.jpg?9733", stock=300),
        Product(name="Baseball Bat", description="Aluminum baseball bat.", price=49.99, category_id=2, image_url="https://i5.walmartimages.com/asr/3ca86834-2713-44c3-a10a-1673832e71a6.128baedba5bd72004540e893656e79de.png?odnHeight=768&odnWidth=768&odnBg=FFFFFF", stock=70),
        Product(name="Tennis Racket", description="Lightweight tennis racket.", price=59.99, category_id=2, image_url="https://i5.walmartimages.com/seo/Wilson-Burn-Pink-25-in-Junior-Tennis-Racket-Ages-9-10_6f2317be-6133-4a23-8125-2ce46285260c.851da120f1cb97923c875bfb49af7f90.png", stock=100),
        Product(name="Golf Clubs", description="Full set of golf clubs.", price=499.99, category_id=2, image_url="https://www.collinsdictionary.com/images/full/golfclub_115180627_1000.jpg", stock=30),
        Product(name="Basketball", description="Indoor/outdoor basketball.", price=29.99, category_id=2, image_url="https://pimage.sport-thieme.com/facebook-open-graph/268-9119", stock=200),
        ...
        Product(name="Cricket Bat", description="Professional-grade cricket bat.", price=74.99, category_id=2, image_url="https://i5.walmartimages.com/asr/ba2d6248-935c-44da-814e-61e583b8aad7.4b38542ed84d1fcea038fea333602968.png", stock=60),
    ]
